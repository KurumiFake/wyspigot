...
minecraftversion=$(cat "$basedir"/FlamePaper/Paper/work/BuildData/info.json | grep minecraftVersion | cut -d '"' -f 4)
...
pushRepo FlamePaper-API $PAPER_API_REPO $tag
pushRepo FlamePaper-Server $PAPER_SERVER_REPO $tag
